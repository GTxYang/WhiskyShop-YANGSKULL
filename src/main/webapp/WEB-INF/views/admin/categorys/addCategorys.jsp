...
<body>
	...
	<div class="form-w3layouts">
		<div class="row">
			<div class="col-lg-12">
				<section class="panel">
					<header class="panel-heading"> Form Add Category <span class="tools pull-right"> <a
					...
					<div class="panel-body">
						<div class="position-center ">
							<form:form class="cmxform form-horizontal" modelAttribute="category"  method="post" action="" novalidate="novalidate">
								
								<div class="form-group">
									<label class="col-sm-3 control-label col-lg-3">Category name</label>
									<div class="col-lg-6">
