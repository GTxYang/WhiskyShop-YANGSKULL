					...
					<div class="panel-body">
						<div class="position-center ">
							<form:form modelAttribute="product"
								class="cmxform form-horizontal" method="post" action="editProduct"
								novalidate="novalidate" enctype="multipart/form-data">
								<form:input path="id" type="hidden" />
								<div class="form-group">
									<label class="col-sm-3 control-label col-lg-3">Product
										Name</label>
									<div class="col-lg-6">
...
<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-lg-6">
										<div class="input-group m-bot15" style="margin-bottom: 7px;">
											...
											<form:input path="volumn" type="text" class="form-control"
												value="${detailProductDTO.volumn }" />
								...
								<div class="form-group">
									...
									<div class="col-lg-6">
										<div class="input-group m-bot15" style="margin-bottom: 7px;">
											<span class="input-group-addon btn-white"><i
												class="fa fa-user"></i></span>
											<form:input path="ml" type="text" class="form-control"
												value="${detailProductDTO.ml }" />
								...
								<div class="form-group">
									...
									<div class="col-lg-6">
										<div class="input-group m-bot15" style="margin-bottom: 7px;">
											...
											<form:textarea id="detail" path="detail" type="text"
												class="form-control" value="${detailProductDTO.detail }" />
								...
								<div class="form-group">
									...
									<div class="col-lg-6">
										<div class="input-group m-bot15" style="margin-bottom: 7px;">
											<span class="input-group-addon btn-white"><i
												class="fa fa-user"></i></span>
									<input type="file" class="form-control" name="user-file" multiple="multiple" />
								...
								<div class="form-group">
									...
									<div class="col-lg-6">
										<div class="input-group m-bot15" style="margin-bottom: 7px;">
											<span class="input-group-addon btn-white"><i
												class="fa fa-user"></i></span>
											<form:input path="sale" type="number"
												class="form-control numbers" />
									...
									<div class="col-lg-6">
										<div class="input-group m-bot15" style="margin-bottom: 7px;">
											...
											<form:select class="form-control m-bot15" path="id_brand">
												<form:options items="${listBrand}" itemLabel="name"
													itemValue="id" />
								...
								<div class="form-group">
									<label class="col-sm-3 control-label col-lg-3">High
										light</label>
									<div class="col-lg-6">
										<div class="input-group m-bot15" style="margin-bottom: 7px;">
											<span class="input-group-addon btn-white"><i
								...
								<div class="form-group">
									<label class="col-sm-3 control-label col-lg-3">New
										Product</label>
									<div class="col-lg-6">
										<div class="input-group m-bot15" style="margin-bottom: 7px;">
											<span class="input-group-addon btn-white"><i
