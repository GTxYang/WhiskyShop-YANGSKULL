				...
				<section class="panel">
					...
					<div class="panel-body">
						<div class="position-center ">
							<form:form class="cmxform form-horizontal" modelAttribute="slide"  method="post" action="" novalidate="novalidate" enctype="multipart/form-data">
								<form:input path="id"/>
								<div class="form-group">
									<label class="col-sm-3 control-label col-lg-3">Caption</label>
									<div class="col-lg-6">
										<div class="input-group m-bot15" style="margin-bottom: 7px;">
											<span class="input-group-addon btn-white"><i
											    ...
											    <form:errors path="caption" style="color:red !important" />
										</div>
									</div>
								</div>
	
								<div class="form-group">
									<label class="col-sm-3 control-label col-lg-3">Content</label>
									<div class="col-lg-6">
										<div class="input-group m-bot15" style="margin-bottom: 7px;">
