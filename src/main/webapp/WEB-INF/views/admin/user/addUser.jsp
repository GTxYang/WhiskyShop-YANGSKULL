...
<c:if test="${not empty status}">
	...
	<div class="form-w3layouts">
		<div class="row">
			<div class="col-lg-12">
				<section class="panel">
					<header class="panel-heading"> Add User <span class="tools pull-right"> <a
					...
					<div class="panel-body">
						<div class="position-center ">
							<form:form class="cmxform form-horizontal" modelAttribute="user"  method="post" action="" novalidate="novalidate">
								...
								<div class="form-group">
									...
									<div class="col-lg-6">
										<div class="input-group m-bot15" style="margin-bottom: 7px;">
											<span class="input-group-addon btn-white"><i class="fa fa-key"></i></span> 
											<input name="nhaplaimatkhau" type="password" class="form-control"  />
								...
								<!-- <div class="form-group">
									...
									<div class="col-lg-6">
										<div class="input-group m-bot15" style="margin-bottom: 7px;">
											<span class="input-group-addon btn-white"><i
												class="fa fa-power-off"></i></span> <input type="text"
